...
export const story: StoryData = {
  ...
  nodes: {
    ...
    apology_question: {
      ...
      text: [
        ...
        "One of the beer mats lands face up.",
        ...
        "Boron.",
        "Sarah picks it up.",
        "'{subjectName}, is this a shopping list?'",
        "{subjectName} takes it from her a bit too quickly.",
        "'No.'",
        "Victoria leans over.",
        "'Then why is Boron on it?'",
        "{subjectName} folds the beer mat in half.",
        "'It made sense at the time.'",
        "Sarah says, 'That is what he says about most things.'",
      ],
      choices: [
        {
          id: "shopping_list_cupboards",
          label: "If that's a shopping list, I worry about your cupboards.",
          nextId: "attention_question",
          type: "score",
          effects: { state: "playful", scores: { humour: 2, curiosity: 1 } },
        },
        {
          id: "flirting_homework",
          label: "Is this how you flirt? Giving people homework?",
          nextId: "attention_question",
          type: "score",
          effects: { state: "playful", scores: { directness: 2, humour: 1, openness: 1 } },
        },
        {
          id: "notice_infinity",
          label: "Infinity on its end is eight, isn't it?",
          nextId: "attention_question",
          type: "score",
          effects: { state: "curious", scores: { curiosity: 2, directness: 1 } },
        },
        {
          id: "choose_not_to_ask",
          label: "I'm choosing not to ask.",
          nextId: "attention_question",
          type: "toneShift",
          effects: { state: "guarded", scores: { humour: 1, respectForBoundaries: 1, curiosity: -1 } },
        },
        {
          id: "boron_ambitious",
          label: "Boron is on your shopping list. That feels ambitious.",
          nextId: "attention_question",
          type: "score",
          effects: { state: "playful", scores: { humour: 1, curiosity: 2 } },
        },
      ],
    },
    attention_question: {
    ...
    number_exchange_warm: {
      ...
      text: [
        ...
        "'I'd like that.'",
        "{subjectName} takes out his phone, then hesitates.",
        "'Actually, this may be worse.'",
        "He pulls the folded beer mat from his pocket.",
        "It is the same one Sarah called a shopping list.",
        "Infinity on its end.",
        "The first and last numbers of the beast.",
        "Gold Rings.",
        "67th prime.",
        "Henry VIII’s wives.",
        "Boron.",
        "'You were not meant to have to solve it in the pub,' he says. 'That would be ridiculous.'",
        "A pause.",
        "'I did consider it, though.'",
        "He holds it out.",
        "'If you still want my number, that is technically it.'",
        "He still takes your number too, because even he seems to realise there are limits.",
        "Then he offers his arm again and walks you the rest of the way home.",
      ],
      choices: [
        {
          id: "homework_number_warm",
          label: "Of course you made your number into homework.",
          nextId: "ending_good_next_time",
          type: "score",
          effects: { state: "playful", scores: { humour: 1, openness: 1 } },
        },
        {
          id: "keep_beer_mat_warm",
          label: "I'm keeping the beer mat.",
          nextId: "ending_good_next_time",
          type: "score",
          effects: { state: "warm", scores: { openness: 1, curiosity: 1 } },
        },
        {
          id: "sweet_or_help_warm",
          label: "This is either sweet or a cry for help.",
          nextId: "ending_good_next_time",
          type: "score",
          effects: { state: "playful", scores: { humour: 1 } },
        },
        {
          id: "work_it_out_later_warm",
          label: "I'll work it out later.",
          nextId: "ending_good_next_time",
          type: "score",
          effects: { state: "curious", scores: { curiosity: 1, openness: 1 } },
        },
        {
          id: "could_have_asked_phone_warm",
          label: "You could have just asked for my phone.",
          nextId: "ending_good_next_time",
          type: "score",
          effects: { state: "warm", scores: { directness: 1, humour: 1 } },
        },
      ],
    },
    number_exchange_awkward: {
      ...
      text: [
        ...
        "'I'd like that.'",
        "He reaches into his pocket and pulls out the folded beer mat from earlier.",
        "'The shopping list was meant to be my number. Sort of.'",
        "He looks at it, then at you.",
        "'That sounded less odd in my head.'",
        "The beer mat still says:",
        "Infinity on its end.",
        "The first and last numbers of the beast.",
        "Gold Rings.",
        "67th prime.",
        ...
        "He still takes your number too, then walks you the rest of the way home.",
      ],
      choices: [
        {
          id: "homework_number_awkward",
          label: "Of course you made your number into homework.",
        ...
        {
          id: "work_it_out_later_awkward",
          label: "I'll work it out later.",
          nextId: "ending_hopeful_awkward",
          type: "score",
          effects: { state: "curious", scores: { curiosity: 1, accountability: 1 } },
        },
        {
          id: "could_have_asked_phone_awkward",
          label: "You could have just asked for my phone.",
          nextId: "ending_hopeful_awkward",
          type: "score",
          effects: { state: "warm", scores: { directness: 1, accountability: 1 } },
        },
      ],
    },
    walk_home_cool: {
  ...
  endings: {
    ...
    ending_good_next_time: {
      ...
      summary: "{subjectName} walks you home. You still have the folded beer mat in your pocket. It turns out the shopping list was not a shopping list. Next time feels like a real possibility.",
    },
    ending_hopeful_awkward: {
      id: "ending_hopeful_awkward",
      title: "Hopeful, If A Little Awkward",
      summary: "It is a little awkward for a minute, but you both recover. He still gives you the folded beer mat and walks you home.",
    },
